...
static void pwm_ledc_init(void)
{
    ...
    ledc_channel.channel = LEDC_CHANNEL_IN1_1;
    ledc_channel.gpio_num = GPIO_DRV8833_IN1_1;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN2_1;
    ledc_channel.gpio_num = GPIO_DRV8833_IN2_1;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN3_1;
    ledc_channel.gpio_num = GPIO_DRV8833_IN3_1;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN4_1;
    ledc_channel.gpio_num = GPIO_DRV8833_IN4_1;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN1_2;
    ledc_channel.gpio_num = GPIO_DRV8833_IN1_2;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN2_2;
    ledc_channel.gpio_num = GPIO_DRV8833_IN2_2;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN3_2;
    ledc_channel.gpio_num = GPIO_DRV8833_IN3_2;
    ledc_channel_config(&ledc_channel);

    ledc_channel.channel = LEDC_CHANNEL_IN4_2;
    ledc_channel.gpio_num = GPIO_DRV8833_IN4_2;
    ledc_channel_config(&ledc_channel);
}
